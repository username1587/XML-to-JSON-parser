...
import { IMAGE_KEY, LISTING_TYPE_KEY, PRICE_RANGE_KEY, SPACE_M2_OPTION_KEY, UNIQUE_ID_KEY } from "./interfaces.js";
import { downloadImage, findProperty } from "./helpers.js";
async function xmlToJson(uniqueId) {
    ...
    const jsonOutput = {
        ...
        [SPACE_M2_OPTION_KEY]: property[SPACE_M2_OPTION_KEY][0],
        [PRICE_RANGE_KEY]: property[PRICE_RANGE_KEY][0],
